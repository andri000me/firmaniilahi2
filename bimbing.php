                ...
                <div class="row">
                    <div class="col-lg-8">
                        ...
                        <div class="about-right mb-90">
                            ...
                            <div class="about-img">
                            <img src="admin/dist/images/fotoberita/<?= $tampil['berita_gambar'] ?> " width="100"  alt="">
                                ...
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        ...
                                        <div class="trend-top-cap trend-top-cap2">
                                            ...
                                            <h2><a href="genjot.php">
                                            <?= $tampil['berita_judul'] ?></a></h2>
                                            <p><?= $tampil['berita_tgl'] ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src="admin/dist/images/fotoberita/<?= $tampil['berita_gambar'] ?>" alt="">
                                        <div class="trend-top-cap trend-top-cap2">
                                            <span class="bgg"><?= $tampil['kategori_nama']  ?> </span>
                                            <h2><a href="alat.php"><?= $tampil['berita_judul'] ?></a></h2>
                                            <p><?= $tampil['berita_tgl'] ?></p>
                                        </div>
                                    </div>
                                </div>
