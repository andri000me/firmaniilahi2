                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                        <!-- card one -->
                                        <?php 
                            $tampil = $koneksi->query("SELECT * FROM tbl_berita a JOIN tbl_kategori b ON a.kategori_id = b.kategori_id WHERE a.berita_id = 7")->fetch_assoc();
                            ?>
                                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">       
                                            <div class="row">
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="whats-news-single mb-40 mb-40">
                                                        ...
                                                        <div class="whates-caption whates-caption2">
                                                            <h4><a href="garbata.php"><?= $tampil['berita_judul'] ?>
                                                                </a></h4>
                                                ...
                                                <?php 
                            $tampil = $koneksi->query("SELECT * FROM tbl_berita a JOIN tbl_kategori b ON a.kategori_id = b.kategori_id WHERE a.berita_id = 15")->fetch_assoc();
                            ?>
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="whats-news-single mb-40 mb-40">
                                                        <div class="whates-img">
                                                        ...
                                                        <div class="whates-caption whates-caption2">
                                                            <h4><a href="labor.php"><?= $tampil['berita_judul'] ?>
</a></h4>
                                                            <span><?= $tampil['berita_tgl'] ?></span>
                                                            <?= substr($tampil['berita_isi'],0,60) ?>
                                                        </div>
                            ...
                            ?>
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="whats-news-single mb-40 mb-40">
                                                        ...
                                                        <div class="whates-caption whates-caption2">
                                                            <h4><a href="batik.php"><?= $tampil['berita_judul'] ?>
                                                                </a></h4>
                                                            <span><?= $tampil['berita_tgl'] ?></span>
                                                            <?= substr($tampil['berita_isi'],0,60) ?>
                                                        </div>
                                                ...
                                                <?php 
                            $tampil = $koneksi->query("SELECT * FROM tbl_berita a JOIN tbl_kategori b ON a.kategori_id = b.kategori_id WHERE a.berita_id = 9")->fetch_assoc();
                            ?>
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="whats-news-single mb-40 mb-40">
                                                        <div class="whates-img">
                                                ...
                                                <?php 
                            $tampil = $koneksi->query("SELECT * FROM tbl_berita a JOIN tbl_kategori b ON a.kategori_id = b.kategori_id WHERE a.berita_id = 11")->fetch_assoc();
                            ?>
                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                    <div class="whats-news-single mb-40 mb-40">
                                                        <div class="whates-img">
                    ...
                    <div class="single-wrap">
                        <nav aria-label="Page navigation example">
                            ...
                            <li class="page-item"><a class="page-link" href="">
                                ...
                                <li class="page-item active"><a class="page-link" href="categori.php">01</a></li>
                                <li class="page-item"><a class="page-link" href="1.php">02</a></li>
